...
class IField extends StatelessWidget {
  ...
  ///   filled: true, // Set the input field with a filled background.
  ///   obscureText: true, // Make the input text obscure for password entry.
  ///   readOnly: false, // Allow or disallow user input.
  ///   validator: (value) {
  ...
  ///     return null;
  ///   },
  ///   fillColour: Colors.blue, // Set a custom fill color for the input field.
  ///   suffixIcon: Icon(Icons.lock), // Add a suffix icon.
  ///   hintText: 'Enter your password', // Set a placeholder text.
  ///   keyboardType: TextInputType.text, // Define the keyboard type.
  ///   hintStyle: TextStyle(
  ///     fontSize: 16,
  ///     fontWeight: FontWeight.w400,
  ///     color: Colors.grey,
  ///   ), // Customize the hint text's style.
  ///   overrideValidator: false, // Use or override default validation.
  /// )
  /// ```
  const IField({
